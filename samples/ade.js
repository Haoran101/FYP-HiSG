function printStackTrace(a) {
    var b = a && a.e ? a.e : null,
        c = !a || !!a.guess,
        d = Object.create(printStackTrace_impl),
        e = d.run(b);
...
if (AR.build = AR.build || {}, !AR.build.mobile) {
    ...
    AR.build = AR.build || {}, AR.build.desktop = !0, AR = AR || {}, AR.js = AR.js || {}, AR.js.clickbuster = {}, AR.js.clickbuster.preventGhostClick = function (a, b) {
        ...
        for (var b = 0; b < a.drawables.length; b++) {
            ...
            if (c && c.onClick)
                if (a.drawables[b].drawableParts) {
    ...
    AR.isDefined = function (a) {
        ...
        }, AR.__architectBuildVersion__ = 990,
        function () {
            var a = function (a) {
                ...
                if (f && c) switch (c.type || (c = {
                    ...
                    case _PROPERTY_VALIDATOR.TYPE.ARRAY:
                        ...
                        for (var g = 0; g < b.length; g++)
                            if (!(b[g] instanceof c.ofType)) throw AR.EXCEPTION.create(a, AR.EXCEPTION.TYPE.ARRAY_CONTENT);
                        break;
                    ...
                    case _PROPERTY_VALIDATOR.TYPE.RGBA:
                        ...
                        b = b.toUpperCase();
                        for (var i = "0123456789ABCDEF", g = 1; g < h; g++)
                            if (i.indexOf(b.charAt(g)) < 0) throw AR.EXCEPTION.create(a, AR.EXCEPTION.TYPE.HEX);
                        return 7 == h && (b += "FF"), b;
            ...
            init: function (a, b) {
                ...
                var l = function (a) {
                    ...
                    m = function () {
                        var a;
                        if (null === j) a = l(g), j = a, null !== a && n(a);
                        else {
            ...
            init: function (a) {
                this._super();
                var b, c, d, e, f, g, h, i, j, k, l, m, n, o = null,
                    p = !0,
                    q = 0;
            ...
            init: function (a) {
                this._super();
                var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r = !0,
                    s = !0,
                    t = !0;
                return a && (r = _PROPERTY_VALIDATOR.validate("enabled", a.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), null == r && (r = !0), s = _PROPERTY_VALIDATOR.validate("mirrored", a.mirrored, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), null == s && (s = !0), t = _PROPERTY_VALIDATOR.validate("rotatesToCamera", a.rotatesToCamera, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), null == t && (t = !0), a.triggers && (b = _PROPERTY_VALIDATOR.validate("onClick", a.triggers.onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onClick && (b = _PROPERTY_VALIDATOR.validate("onClick", a.onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDragBegan && (c = _PROPERTY_VALIDATOR.validate("onDragBegan", a.onDragBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDragChanged && (d = _PROPERTY_VALIDATOR.validate("onDragChanged", a.onDragChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDragEnded && (e = _PROPERTY_VALIDATOR.validate("onDragEnded", a.onDragEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onPanBegan && (f = _PROPERTY_VALIDATOR.validate("onPanBegan", a.onPanBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onPanChanged && (g = _PROPERTY_VALIDATOR.validate("onPanChanged", a.onPanChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onPanEnded && (h = _PROPERTY_VALIDATOR.validate("onPanEnded", a.onPanEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onRotationBegan && (i = _PROPERTY_VALIDATOR.validate("onRotationBegan", a.onRotationBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onRotationChanged && (j = _PROPERTY_VALIDATOR.validate("onRotationChanged", a.onRotationChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onRotationEnded && (k = _PROPERTY_VALIDATOR.validate("onRotationEnded", a.onRotationEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onScaleBegan && (l = _PROPERTY_VALIDATOR.validate("onScaleBegan", a.onScaleBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onScaleChanged && (m = _PROPERTY_VALIDATOR.validate("onScaleChanged", a.onScaleChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onScaleEnded && (n = _PROPERTY_VALIDATOR.validate("onScaleEnded", a.onScaleEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), p = new AR.DrawableTranslate(this, a && a.translate ? a.translate : null), q = new AR.DrawableScale(this, a && a.scale ? a.scale : null), o = new AR.DrawableRotate(this, a && a.rotate ? a.rotate : null), this.__defineSetter__("enabled", function (a) {
                    ...
                    var b = _PROPERTY_VALIDATOR.validate("rotate", a, _PROPERTY_VALIDATOR.TYPE.OBJECT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET),
                        c = {
                            is: "AR.i.drawableInterface.setRotation",
                            objectId: this.__id
                        };
                    ...
                    var b = _PROPERTY_VALIDATOR.validate("translate", a, _PROPERTY_VALIDATOR.TYPE.OBJECT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET),
                        c = {
                            is: "AR.i.drawableInterface.setTranslate",
                            objectId: this.__id
                        };
                    ...
                    var c = {
                        is: "AR.i.drawableInterface.setScale",
                        objectId: this.__id
                    };
                    ...
                    return b
                }), this.__defineSetter__("__onClick__", function (a) {}), this.__defineGetter__("__onClick__", function () {
                    var a = function () {
                        return null
                    };
            ...
            init: function (a, b) {
                ...
                b && (b.x && (e = _PROPERTY_VALIDATOR.validate("rotate.x", b.x, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), b.y && (f = _PROPERTY_VALIDATOR.validate("rotate.y", b.y, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), b.z && (g = _PROPERTY_VALIDATOR.validate("rotate.z", b.z, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), b.tilt && (b.global ? b.global.x = _PROPERTY_VALIDATOR.validate("rotate.tilt", b.tilt, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) : b.global = {
                    x: _PROPERTY_VALIDATOR.validate("rotate.tilt", b.tilt, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }), b.heading && (b.global ? b.global.y = _PROPERTY_VALIDATOR.validate("rotate.heading", b.heading, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) : b.global = {
                    y: _PROPERTY_VALIDATOR.validate("rotate.heading", b.heading, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }), b.roll && (b.global ? b.global.z = _PROPERTY_VALIDATOR.validate("rotate.roll", b.roll, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) : b.global = {
                    z: _PROPERTY_VALIDATOR.validate("rotate.roll", b.roll, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                })), c = new AR.DrawableGlobalRotation(d, b && b.global ? b.global : null), this.setX = function (a, b) {
            ...
            init: function (a, b, c) {
                var d = this.validateHorizontalAnchor(a),
                    ...
                    f = 1,
                    g = 0;
                null != c && (null != c.horizontalAnchor && (d = this.validateHorizontalAnchor(c.horizontalAnchor)), null != c.verticalAnchor && (e = this.validateVerticalAnchor(c.verticalAnchor)), null != c.opacity && (f = this.validateOpacity(c.opacity)), null != c.zOrder && (g = this.validateZOrder(c.zOrder))), c && (c.rotation && (c.rotate ? c.rotate.z = c.rotation : c.rotate = {
                    z: c.rotation
                }), c.offsetX && (c.translate ? c.translate.x = c.offsetX : c.translate = {
                    x: c.offsetX
                }), c.offsetY && (c.translate ? c.translate.y = c.offsetY : c.translate = {
                    y: c.offsetY
                }));
                var h = this._super(c);
            ...
            init: function (a, b, c) {
                ...
                var e = this.validateHeight(b),
                    f = null;
                null != c ? (f = new AR.Style(this, c.style), c.mirrored || (c.mirrored = !1)) : (f = new AR.Style(this, null), c = {
                    mirrored: !1
                });
            ...
            isInitialized: function () {
                return AR.i.callSync({
                    is: "AR.i.modelInterface.isInitialized",
                    objectId: this.__id
                })
            }
            ...
            validateKeyFrameArray: function (a) {
                ...
                for (var b = 0; b < a.length; b++)
                    if ("number" != typeof a[b] || Math.round(a[b]) != a[b]) throw AR.EXCEPTION.create(name, AR.EXCEPTION.TYPE.ARRAY_CONTENT);
                return a
            }
            ...
            init: function (a, b, c, d) {
                this._super();
                var e = this.validateLatitude(a),
                    f = this.validateLongitude(b),
                    g = this.validateAltitude(c),
                    h = null;
            ...
            init: function (a, b) {
                ...
                var f = this.validateLocations(a),
            ...
            validateLocations: function (a) {
                ...
                else if (!AR.VALIDATE.isArrayOf(a, AR.Location)) throw AR.EXCEPTION.create("locations", AR.EXCEPTION.TYPE.ARRAY_CONTENT);
                return a
            }
            ...
            play: function (a) {
                if (void 0 === a) a = 1;
                else if (!AR.VALIDATE.isWholeNumber(a)) throw AR.EXCEPTION.create("loopTimes", AR.EXCEPTION.TYPE.INT);
                AR.i.callAsync({
                    objectId: this.__id,
            ...
            IMAGE_RECOGNITION_RANGE_EXTENSION: {
                ...
                OFF: 0,
                AUTO: 2,
                isValidRangeExtension: function (a) {
                    switch (a) {
            ...
            INSTANT_TARGET_EXPANSION_POLICY: {
                ALLOW_EXPANSION: 0,
                DISALLOW_EXPANSION: 1
            },
            TRACKER_EFFICIENCY_MODE: {
                HIGH_ACCURACY: 0,
                ENERGY_EFFICIENCY: 1,
                isValidTrackerEfficiencyMode: function (a) {
                    switch (a) {
            ...
            init: function () {
                ...
                _destroyAll = function () {
                    ...
                    return AR.i.callSync({
                        is: "AR.i.contextInterface.getVersionNumber"
                    })
                });
                var p = function () {
                        var a = 5e4,
            ...
            init: function () {
                var a = function () {
                        var a = !0,
                            b = !1,
                            c = 1,
                            d = AR.CONST.CAMERA_POSITION.BACK,
                            e = AR.CONST.CAMERA_FOCUS_MODE.CONTINUOUS,
                            f = 0,
                            g = null;
                        this.__defineGetter__("enabled", function () {
                            return a
                            ...
                            return AR.i.callSync({
                                is: "AR.i.hardwareInterface.isFlashlightAvailable"
                            })
                            ...
                            return AR.i.callSync({
                                is: "AR.i.hardwareInterface.camera_getCameraPosition"
                            })
                            ...
                            return AR.i.callSync({
                                is: "AR.i.hardwareInterface.camera_isCameraManualFocusAvailable"
                            })
                            ...
                            return AR.i.callSync({
                                is: "AR.i.hardwareInterface.camera_getCameraManualFocusDistance"
                            })
                            ...
                            AR.i.callAsync({
                                is: "AR.i.hardwareInterface.camera_setFocusPointOfInterest",
                                x: a.x,
                                y: a.y
                            })
                        }, this.setExposurePointOfInterest = function (a) {
                            AR.i.callAsync({
                                is: "AR.i.hardwareInterface.camera_setExposurePointOfInterest",
                                x: a.x,
                                y: a.y
                            })
                        }, this.__defineGetter__("features", function () {
                            return AR.i.callSync({
                                is: "AR.i.hardwareInterface.getCameraFeatures"
                            })
                    ...
                    b = function () {
                        ...
                        var a = function () {
                                this.__defineGetter__("correctionAngle", function () {
                                    return AR.i.callSync({
                                        is: "AR.i.hardwareInterface.compass_getCorrectionAngle"
                                    })
                    ...
                    d = function () {
                        this.SmartAvailability = {
                            ...
                            AR.i.callAsync({
                                is: "AR.i.hardwareInterface.arKitCore_isDeviceSupported"
                            })
            ...
            init: function () {
                ...
                this.__defineSetter__("enabled", function (a) {
                    ...
                    if (d) {
                        var a = 0,
                            b = 0;
                        if (0 === j && 0 === k) a = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, j = a, b = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight, k = b, l.notifyUpdateRadarPositionHelper(d.getBoundingClientRect(), a, b);
                        else {
            ...
            for (var d = 0; d < a.drawables.length; d++) {
                ...
                if (e && e.onDragBegan)
                    if (a.drawables[d].drawableParts && a.drawables[d].planeIntersection) {
            ...
            for (var d = 0; d < a.drawables.length; d++) {
                var e = AR.om.getObjectForID(a.drawables[d].drawable);
                if (e && e.onPanBegan)
                    if (a.drawables[d].drawableParts) {
            ...
            for (var c = 0; c < a.drawables.length; c++) {
                ...
                if (d && d.onRotationBegan)
                    if (a.drawables[c].drawableParts) {
            ...
            init: function (a) {
                var b, c, d, e, f = !0,
                    g = 1,
                    h = AR.CONST.INITIAL_INSTANT_TRACKING_PLANE_ORIENTATION.HORIZONTAL,
                    i = !0,
                ...
                e = AR.om.createObjectID(), AR.i.callAsync({
                    ...
                    return AR.i.callSync({
                        objectId: e,
                        is: "AR.i.instantTrackerInterface.getState"
                    })
                    ...
                    return AR.i.callSync({
                        objectId: e,
                        is: "AR.i.instantTrackerInterface.canStartTracking"
                    })
                }), this.__defineSetter__("enabled", function (a) {
                    a = _PROPERTY_VALIDATOR.validate("enabled", a, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), AR.i.callAsync({
                        objectId: e,
                    ...
                    return AR.i.callSync({
                        objectId: e,
                        is: "AR.i.instantTrackerInterface.isEnabled"
                    })
                }), this.__defineSetter__("onError", function (a) {
            ...
            init: function (a, b) {
                b = b || {};
                var c, d, e, f, g, h, i = this._super(b),
                    j = _PROPERTY_VALIDATOR.validate("tracker", a, {
                        type: _PROPERTY_VALIDATOR.TYPE.CLASS,
            ...
            this.addPluginAvailabilityObserver = function (b) {
                ...
                return AR.i.callSync({
                    is: "AR.i.pluginInterface.callSync",
                    pluginId: a,
                    methodId: b,
                    parameter: c
                })
                ...
                AR.i.callAsync({
                    is: "AR.i.pluginInterface.callAsync",
                    pluginId: a,
                    methodId: b,
                    parameter: c
                })
            ...
            isLoaded: function () {
                return AR.i.callSync({
                    is: "AR.i.occluderInterface.isLoaded",
                    objectId: this.__id
                })
            },
            isInitialized: function () {
                return AR.i.callSync({
                    is: "AR.i.occluderInterface.isInitialized",
                    objectId: this.__id
                })
            }
            ...
            init: function (a, b, c, d) {
                ...
                d ? d.rotatesToCamera || (d.rotatesToCamera = !1) : d = {
                    rotatesToCamera: !1
                }, this.__defineSetter__("__id", function (a) {
                    throw AR.EXCEPTION.create("__id", AR.EXCEPTION.TYPE.IMMUTABLE)
                }), this.__defineGetter__("__id", function () {
            ...
            init: function (a, b) {
                ...
                var d, e, f, g = a.__id,
                    h = !0,
                    i = AR.CONST.TRACKER_EFFICIENCY_MODE.HIGH_ACCURACY;
                b && (null != b.enabled && (h = _PROPERTY_VALIDATOR.validate("enabled", b.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.trackerEfficiencyMode && (i = this.validateTrackerEfficiencyMode(b.trackerEfficiencyMode)), b.onError && (d = _PROPERTY_VALIDATOR.validate("onError", b.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onDisabled && (e = _PROPERTY_VALIDATOR.validate("onDisabled", b.onDisabled, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onTargetsLoaded && (f = _PROPERTY_VALIDATOR.validate("onTargetsLoaded", b.onTargetsLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), c = AR.om.createObjectID(), AR.i.callAsync({
                    ...
                    return AR.i.callSync({
                        objectId: c,
                        is: "AR.i.objectTrackerInterface.isEnabled"
                    })
                }), this.__defineSetter__("onError", function (a) {
            ...
            init: function (a, b, c) {
                c = c || {};
                var d, e, f, g, h, i, j = this._super(c),
                    k = _PROPERTY_VALIDATOR.validate("tracker", a, {
                        type: _PROPERTY_VALIDATOR.TYPE.CLASS,
                        ofType: AR.ARchitectObject
                ...
                var n = _PROPERTY_VALIDATOR.validate("enableExtendedTracking", !!c.enableExtendedTracking && c.enableExtendedTracking, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY),
                    ...
                    q = AR.om.createObjectID(),
                    r = m.resolvedBoundingBox;
                AR.i.callAsync({
                    objectId: q,
            ...
            stopExtendedTracking: function () {
                AR.i.callAsync({
                    objectId: this.__id,
                    is: "AR.i.objectTrackableInterface.stopExtendedTracking"
                })
            }
            ...
            init: function (a, b) {
                ...
                var c, d, e, f, g, h = a.__id,
                    i = !0,
                    j = AR.CONST.IMAGE_RECOGNITION_RANGE_EXTENSION.AUTO,
                    k = 1,
                    l = AR.CONST.TRACKER_EFFICIENCY_MODE.HIGH_ACCURACY,
                    m = 0,
                    n = 0,
                    o = 0;
                if (b) {
                ...
                c = AR.om.createObjectID(), AR.i.callAsync({
                    ...
                    return AR.i.callSync({
                        objectId: c,
                        is: "AR.i.imageTrackerInterface.isEnabled"
                    })
            ...
            init: function (a, b) {
                var c, d, e, f, g = _PROPERTY_VALIDATOR.validate("url", a, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
                b && (b.onProgress && (c = _PROPERTY_VALIDATOR.validate("onProgress", b.onProgress, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onLoaded && (d = _PROPERTY_VALIDATOR.validate("onLoaded", b.onLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onError && (e = _PROPERTY_VALIDATOR.validate("onError", b.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), f = AR.om.createObjectID(), AR.i.callAsync({
                    ...
                    return AR.i.callSync({
                        objectId: f,
                        is: "AR.i.targetCollectionResourceInterface.isLoading"
                    })
                    ...
                    AR.i.callAsync({
                        objectId: f,
                        is: "AR.i.targetCollectionResourceInterface.cancel"
                    })
                }
            }
            ...
            init: function (a, b, c, d) {
                ...
                h && (h.onInitialized && (i = _PROPERTY_VALIDATOR.validate("onInitialized", h.onInitialized, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), h.onError && (j = _PROPERTY_VALIDATOR.validate("onError", h.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), h.cloudRecognitionServerURL && (r = _PROPERTY_VALIDATOR.validate("cloudRecognitionServerURL", h.cloudRecognitionServerURL, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), k = AR.om.createObjectID(), AR.i.callAsync({
                    ...
                    AR.i.callAsync({
                        is: "AR.i.cloudRecognitionServiceInterface.stopContinuousRecognition",
                        objectId: k
                    })
            ...
            init: function (a, b, c) {
                ...
                var f, g, h, i, j, k, l = _PROPERTY_VALIDATOR.validate("targetName", b, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET),
                    m = new AR.ScreenSnapper(this, c.snapToScreen ? c.snapToScreen : null),
                ...
                var u = AR.om.createObjectID(),
                    v = m.resolvedBoundingBox;
                AR.i.callAsync({
                    objectId: u,
                    ...
                    var a = AR.i.callSync({
                        objectId: u,
                        is: "AR.i.imageTrackableInterface.getAspectRatio"
                    });
                    return a < 0 ? void 0 : a
                }), this.__defineSetter__("onEnterFieldOfVision", function (a) {
            ...
            stopExtendedTracking: function () {
                AR.i.callAsync({
                    objectId: this.__id,
                    is: "AR.i.imageTrackableInterface.stopExtendedTracking"
                })
            }
    ...
    var printStackTrace_impl = {
        ...
        opera10: function (a) {
            ...
            for (b = 2, c = 0, d = f.length; b < d - 2; b++)
                if (h.test(f[b])) {
        ...
        guessFunctionNameFromLines: function (a, b) {
            for (var c = /function ([^(]*)\(([^)]*)\)/, d = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*(function|eval|new Function)/, e = "", f = 10, g = 0; g < f; ++g)
                if (void 0 !== (e = b[a - g] + e)) {
                    var h = d.exec(e);
                    if (h && h[1]) return h[1];
    ...
    AR.overlay = AR.overlay || {}, AR.overlay.__OVERLAY_CONTAINER__CONSTRUCTION_PLAN = function () {
        ...
        this.appendOverlay = function (a, d, e) {
            ...
            }, g.appendChild(m), h.appendChild(d), b[i] = {
                tab: m,
                htmlElement: d,
                initFunction: e
            }, i++, c++, i - 1
    ...
    var __ARCHITECT_LOGGER_FRAMEWORK__ = new function () {
            ...
            this.setDebugModeEnabled = function (d) {
                if (d)
                    ...
                    } else AR.overlay.OVERLAY_CONTAINER.setVisibility(!0);
                else AR.overlay.OVERLAY_CONTAINER.setVisibility(!1)
            }
        },
        ...
        this.autoLoadResources = !1, this.init = function () {
            ...
            for (objectId in AR.om.__objects__) {
                ...
                a instanceof AR.ImageResource ? AR.i.imageResourceInterface.startLoading({
                    objectId: a.__id
                }) : a instanceof AR.TargetCollectionResource ? AR.i.targetCollectionResourceInterface.startLoading({
                    objectId: a.__id
                }) : a instanceof AR.CloudRecognitionService ? AR.i.cloudRecognitionServiceInterface.startLoading({
                    objectId: a.__id
                    ...
                    objectId: a.__id
                }) : a instanceof AR.Occluder && AR.i.occluderInterface.simulateLoad({
                    objectId: a.__id
                })
            }
    ...
    AR.ADE = AR.ADE || {}, AR.ADE.Tree = function (a) {
            ...
            f = function (a, d, e, f) {
                ...
                this.referencedId = e.value, this.update = function (e) {
                    ...
                    if (i) {
                        ...
                        for (var l = 0; l < g.length; l++) g[l].update(e)
                }
            },
            g = function (a, c, d, f) {
        ...
        explain: function () {
            return {
                ...
                properties: {
                    ...
                    onPanBegan: {
                        type: "trigger",
                        active: this._onPanBeganTriggerActive,
                        trigger: "onPanBegan"
                    },
                    onPanChanged: {
                        type: "trigger",
                    ...
                    onPanEnded: {
                        type: "trigger",
                        active: this._onPanEndedTriggerActive,
                        trigger: "onPanEnded"
                    },
                    onRotationBegan: {
                        type: "trigger",
        ...
        _cameraFocusPointOfInterest: {
            x: 0,
            y: 0
        },
        _cameraExposurePointOfInterest: {
            x: 0,
            y: 0
        },
        ...
        start: function (a) {
            ...
            var g = d[e[e.length - 1]],
                h = AR.__fromJSONString__(b._end)[0],
                i = 100 * (h - g) / b._duration,
                j = function () {
                    if (b.runningId) {
        ...
        startLoading: function (a) {
            var b = AR.i.getBridgeObject(a.objectId);
            b._loaded || b.loading || (b.loading = !0, window.setTimeout(function () {
                AR.i.cloudRecognitionServiceInterface.simulateLoad({
                    objectId: a.objectId
                })
            }, 5e3 * Math.random()))
        },
                    ...
                    return {
                        ...
                        properties: {
                            ...
                            "drawables.initialization": {
                                type: "ids",
                                value: this._initializationDrawableIds
                            },
                            renderingOrder: this._renderingOrder,
                            snapToScreenEnabled: this._snapToScreenEnabled,
                            screenSnapDelay: this._screenSnapDelay,
        ...
        startLoading: function (a) {
            var b = AR.i.getBridgeObject(a.objectId);
            b._loaded || b.loading || (b.loading = !0, window.setTimeout(function () {
                AR.i.imageTrackerInterface.simulateLoad({
                    objectId: a.objectId
                })
            }, 5e3 * Math.random()))
        },
        ...
        startLoading: function (a) {
            var b = AR.i.getBridgeObject(a.objectId);
            b._loaded || b.loading || (b.loading = !0, window.setTimeout(function () {
                AR.i.targetCollectionResourceInterface.simulateLoad({
                    objectId: a.objectId
                })
            }, 5e3 * Math.random()))
        },
